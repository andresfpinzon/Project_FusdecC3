...
const Usuarios = () => {
        ...
        data.map(async (usuario) => {
          try {
            ...
            if (rolesResponse.ok) {
              ...
              console.log(`Roles para usuario ${usuario.numeroDocumento}:`, rolesData);
              return {
                ...usuario,
            ...
            console.error(`Error al obtener roles para usuario ${usuario.numeroDocumento}:`, error);
            return {
              ...usuario,
              roles: []
            };
  ...
  const fetchRolesAsignados = async (documento) => {
    ...
    try {
      ...
      console.log("Roles asignados recibidos:", rolesData);

      // Extraer solo los roles del array de objetos
      const rolesAsignados = rolesData.map(rolObj => rolObj.rol);
      console.log("Roles procesados:", rolesAsignados);
      
      // Actualizar el estado de roles asignados
  ...
  const handleRoleChange = async (event) => {
    ...
    try {
      ...
      console.log("Enviando solicitud de asignación de rol:", requestData);
