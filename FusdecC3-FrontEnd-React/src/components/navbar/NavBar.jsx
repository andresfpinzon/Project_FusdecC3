...
export default function Navbar() {
  ...
  const drawer = (
    <div className={classes.drawer}>
      <List>
      {["Home", "Asistencias", "Auditorias","Brigadas","Certificados","Comandos", "Cursos", "Ediciones", "Más Información", "Estudiantes", "Inasistencias", "Roles", "Unidades", "Usuarios", "Login"].map((text) => (
          <ListItem
            button
