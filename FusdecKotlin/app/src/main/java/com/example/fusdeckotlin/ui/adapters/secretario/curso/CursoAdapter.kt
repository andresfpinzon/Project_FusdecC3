...
class CursoAdapter(
    ...
    override fun onBindViewHolder(holder: CursoViewHolder, position: Int) {
        ...
        holder.nombreTextView.text = curso.getNombre()
        holder.descripcionTextView.text = curso.getDescripcion()
        holder.intensidadHorariaTextView.text = curso.getIntensidadHoraria()
            ...
            override fun performFiltering(constraint: CharSequence?): FilterResults {
                ...
                if (constraint.isNullOrEmpty()) {
                    ...
                    cursos.forEach { curso ->
                        if (curso.getNombre().lowercase().contains(filterPattern) ||
                            curso.getDescripcion().lowercase().contains(filterPattern) ||
                            curso.getIntensidadHoraria().lowercase().contains(filterPattern) ||
