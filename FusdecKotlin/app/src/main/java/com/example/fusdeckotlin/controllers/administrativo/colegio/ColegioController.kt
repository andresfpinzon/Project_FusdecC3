...
class ColegioController() {
    ...
    companion object {
        ...
        fun listarColegiosActivos(colegios: List<Colegio>) {
            val colegiosActivos = ColegioServices.listarColegiosActivos(colegios)
        ...
        fun actualizarColegio(colegios: MutableList<Colegio>) {
            ...
            try {
                val colegio = ColegioServices.obtenerColegioPorId(colegios, id)
                ...
                if (confirmarAccion("¿Desea actualizar este colegio?")) {
                    val colegioActualizado = ColegioServices.actualizarColegio(
                        colegios = colegios,
                        id = id,
                        nombreColegio = nombre,
                        emailColegio = email,
        ...
        fun desactivarColegio(colegios: MutableList<Colegio>) {
            ...
            val id = scanner.next()
            try {
                val colegioDesactivado = ColegioServices.desactivarColegio(colegios, id)
