...
const asistenciaSchemaValidation = Joi.object({
  tituloAsistencia: Joi.string().min(3).max(100).required().messages({
  ...
  fechaAsistencia: Joi.date().required().messages({
