...
// const { verifyJWT, verifyRole } = require('../config/authMiddleware'); // Descomentar para habilitar la protección
 ...
 */
router.get('/', brigadaController.listarBrigadas); // Descomentar verifyJWT y verifyRole para habilitar protección
 ...
 *         description: Error interno del servidor
 */
router.post('/', brigadaController.crearBrigada); // Descomentar verifyJWT y verifyRole para habilitar protección
 ...
 *         description: Error interno del servidor
 */
router.get('/:id', brigadaController.obtenerBrigadaPorId); // Descomentar verifyJWT y verifyRole para habilitar protección
 ...
 *         description: Error interno del servidor
 */
router.put('/:id', brigadaController.actualizarBrigada); // Descomentar verifyJWT y verifyRole para habilitar protección
 ...
 *         description: Error interno del servidor
 */
router.delete('/:id', brigadaController.desactivarBrigada); // Descomentar verifyJWT y verifyRole para habilitar protección
 ...
 *         description: Error interno del servidor
 */
router.post('/:id/unidades', brigadaController.agregarunidades); // Descomentar verifyJWT y verifyRole para habilitar protección
